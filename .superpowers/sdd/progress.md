...
- 011 RE-PLANNED + IMPLEMENTED: fold residual dust into the final winner's claim (no struct change, no new fn); design adversarially verified by 3 Opus skeptics (no-winner safe, conservation holds, pools→0). sui move test **103/103**. **20/20 plans done.** PR #70 updated.
